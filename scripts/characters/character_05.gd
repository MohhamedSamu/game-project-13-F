@tool
extends Node3D
## Personaje base del NPC del supermercado: textura en escena; idle en AnimationPlayer (autoplay).

const MODEL_TEXTURE := "res://assets/characters/npc_supermarket/Character_05.png"
